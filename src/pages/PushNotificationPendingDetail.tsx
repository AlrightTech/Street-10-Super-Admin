      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl bg-white shadow-sm p-4 sm:p-6">
          <div className="space-y-4 sm:space-y-6">
            ...
            {/* Full Message */}
            <div className='bg-gray-200 px-2 pb-12 rounded-lg pt-1 '>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4 flex gap-8">
                <div>
                  ...
                  <div className="mt-2">
                    <span className="inline-flex items-center rounded-md px-3 py-1 text-xs font-medium bg-blue-600 text-white">

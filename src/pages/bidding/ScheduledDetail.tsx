 ...
 */
export default function ScheduledDetail({ product, onClose }: ScheduledDetailProps) {
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Scheduled Product</h1>
          <p className="mt-1 text-sm text-gray-600">
            <span>Dashboard &gt; </span>
            <span className="text-gray-900">Bidding Products &gt; Scheduled</span>
          </p>
        </div>
        <button
          onClick={onClose}
          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <span className="inline-flex items-center rounded-lg px-3 py-1 text-xs font-medium bg-[#118D57] text-white">
                  Scheduled
                </span>
              </div>

              <div className="pt-4 border-t border-gray-200">
                <p className="text-sm text-gray-600 mb-4">This product is scheduled for auction. The bidding will start at the scheduled time.</p>

...
import FullPaymentRequiredDetail from './FullPaymentRequiredDetail'

export default function FullPaymentRequiredDetailRoute() {
  ...
  return <FullPaymentRequiredDetail product={product} auction={auction} mediaUrls={mediaUrls} onClose={() => navigate('/building-products')} />
}

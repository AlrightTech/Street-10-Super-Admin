...
import PaymentRequestedDetail from './PaymentRequestedDetail'

export default function PaymentRequestedDetailRoute() {
  ...
  return <PaymentRequestedDetail product={product} auction={auction} mediaUrls={mediaUrls} onClose={() => navigate('/building-products')} />
}

 ...
 */
export default function FullyPaidSoldDetail({ product, onClose }: FullyPaidSoldDetailProps) {
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Fully Paid - Sold</h1>
          <p className="mt-1 text-sm text-gray-600">
            <span>Dashboard &gt; </span>
            <span className="text-gray-900">Bidding Products &gt; Fully Paid - Sold</span>
          </p>
        </div>
        <button
          onClick={onClose}
          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-500">Sold On</p>
              ...
              <div>
                ...
                <span className="inline-flex items-center rounded-lg px-3 py-1 text-xs font-medium bg-[#FF6B6B] text-white">
                  Fully Paid - Sold
                </span>
              </div>

              <div className="pt-4 border-t border-gray-200">
                <p className="text-sm text-gray-600 mb-4">This product has been successfully sold and payment has been fully received.</p>
                <div className="flex gap-3">
                  <button className="inline-flex items-center justify-center rounded-lg bg-[#118D57] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#0F7A4A] cursor-pointer">
                    View Transaction
                  </button>

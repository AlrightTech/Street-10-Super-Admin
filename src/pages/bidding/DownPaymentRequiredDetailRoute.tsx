...
import DownPaymentRequiredDetail from './DownPaymentRequiredDetail'

export default function DownPaymentRequiredDetailRoute() {
  ...
  return <DownPaymentRequiredDetail product={product} auction={auction} mediaUrls={mediaUrls} onClose={() => navigate('/building-products')} />
}

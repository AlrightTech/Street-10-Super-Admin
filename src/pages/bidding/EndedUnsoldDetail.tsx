 ...
 */
export default function EndedUnsoldDetail({ product, onClose }: EndedUnsoldDetailProps) {
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="rounded-xl bg-white shadow-sm p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Bidding Product Detail</h1>
            <p className="mt-1 text-sm text-gray-600">Manage auction item and bidding activity</p>
          </div>
          <button
            onClick={onClose}
            className="inline-flex items-center justify-center rounded-lg bg-[#F7931E] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#E8840D] cursor-pointer"
          >
            Edit Product
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-4 gap-3">
                  {productImages.slice(0, 4).map((img, index) => (
                    <button
                      ...
                      className={`h-20 w-full rounded-lg overflow-hidden border-2 transition ${
            ...
            <div className="border border-gray-200 rounded-lg bg-[#F3F5F6] p-4">
            ...
            <div className="space-y-4">
              {BIDDING_HISTORY.map((bid) => (
                <div key={bid.id} className="flex items-center gap-4 p-4 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-500">{bid.date}, {bid.time}</span>
                  </div>
                  <div className="text-sm font-medium text-gray-900">{bid.amount}</div>
                  <button className="inline-flex items-center justify-center rounded-lg bg-[#F7931E] px-3 py-1.5 text-xs font-medium text-white cursor-pointer">
                    Bidding
                  </button>
            ...
            <button className="mt-4 w-full inline-flex items-center justify-center rounded-lg bg-[#F7931E] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#E8840D] cursor-pointer">
              View All History
            </button>
            </div>
          </div>

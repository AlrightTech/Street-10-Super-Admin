...
import FinalPaymentRequiredDetail from './FinalPaymentRequiredDetail'

export default function FinalPaymentRequiredDetailRoute() {
  ...
  return <FinalPaymentRequiredDetail product={product} auction={auction} mediaUrls={mediaUrls} onClose={() => navigate('/building-products')} />
}

...
/**
 * Final Payment Required Product Detail page
 */
export default function FinalPaymentRequiredDetail({ product, auction, mediaUrls, onClose: _onClose }: PaymentRequestedDetailProps) {
            ...
            <div className="border border-gray-200 rounded-lg p-4 sm:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#F7931E] text-white rounded-lg p-4">
                  <p className="text-sm font-medium mb-1">Final Payment Required</p>
                  <p className="text-xs text-gray-200">
                    {auction?.endAt ? `Ended: ${formatDate(auction.endAt)}` : 'Final Payment Required'}
                  </p>
                </div>
                ...
                <button 
                  onClick={async () => {
                    ...
                    if (!window.confirm('Are you sure you want to mark the final payment as paid? This will apply the deposit and mark the order as fully paid.')) {
                      return
                    }
                    try {
                      setMarkingPaid(true)
                      await ordersApi.markFinalPaymentPaid(orderId)
                      alert('Final payment marked as paid successfully')
                      ...
                      alert(error.response?.data?.message || 'Failed to mark final payment as paid')
                    } finally {
                ...
                >
                  {markingPaid ? 'Marking...' : 'Mark Final Payment Paid'}
                </button>
              </div>
            </div>

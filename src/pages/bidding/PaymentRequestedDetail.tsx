...
const BIDDING_HISTORY: BidHistoryItem[] = [
  {
    ...
    status: 'Winning - Down Payment undone',
    date: '10/02/2024',
    time: '19:30:00',
    amount: '$520',
    isWinning: true,
 ...
 */
export default function PaymentRequestedDetail({ product, mediaUrls, onClose: _onClose }: PaymentRequestedDetailProps) {
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 pt-4 border-t border-gray-200">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-900">40mm case diameter</span>
                    </div>
                    <div className="flex justify-between">
            ...
            <div className="border border-gray-200 rounded-lg p-4 sm:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#F7931E] text-white rounded-lg p-4">
                  <p className="text-sm font-medium mb-1">Auction Ended - Final Payment Required</p>
                  <p className="text-xs text-gray-200">Time Remaining</p>
                </div>

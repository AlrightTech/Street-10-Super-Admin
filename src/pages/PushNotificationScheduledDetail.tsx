...
export default function PushNotificationScheduledDetail() {
  ...
  useEffect(() => {
    if (id) {
      const found = MOCK_PUSH_NOTIFICATIONS.find((n) => n.id === id && n.status === 'scheduled')
      if (found) {
        setNotification(found)
      } else {
        // Fallback to default scheduled data
        ...
        <div className="rounded-xl bg-white shadow-sm p-4 sm:p-6">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-900">Notification Scheduled</span>
            </div>

            ...
            {activeTab === 'biddings' ? (
                ...
                <tbody>
                  {user.biddings.map((bidding) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-sm font-normal text-gray-600 whitespace-nowrap">{currencyPrefix}{formatAmount(bidding.bidAmount)}</td>
                      <td className="px-4 py-2 text-sm font-normal text-gray-600 whitespace-nowrap">{currencyPrefix}{formatAmount(bidding.currentPrice)}</td>
              ...
              <>
                <thead className="sticky top-0 z-10 bg-white">
                  <tr className="border-b text-left border-gray-200">
                    <th className="text-sm font-semibold py-2 px-4 text-gray-700 whitespace-nowrap bg-white">Product</th>
                    <th className="text-sm font-semibold py-2 px-4 text-gray-700 whitespace-nowrap bg-white">Order ID</th>
                    <th className="text-sm font-semibold py-2 px-4 text-gray-700 whitespace-nowrap bg-white">Amount</th>
                    <th className="text-sm font-semibold py-2 px-4 text-gray-700 whitespace-nowrap bg-white">Status</th>
                    <th className="text-sm font-semibold py-2 px-4 text-gray-700 whitespace-nowrap bg-white">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {user.orders.map((order) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-sm text-gray-600 whitespace-nowrap">{currencyPrefix}{order.amount.toFixed(2)}</td>
                      <td className="px-4 py-2 whitespace-nowrap">
                      ...
                      <td className="px-4 py-2 whitespace-nowrap">
                        <button
                          ...
                          className="text-sm font-medium text-[#F39C12] hover:text-[#E67E22] hover:underline"
                        >
                          View
                        </button>
                      </td>
